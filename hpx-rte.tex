...
\item \textbf{Populating Internal Data Structures}\\
  A number of internal data structures need to be polulated within the runtime environment before starting the MPI initialization. This is done in the runtime initialization function.
