...
HPX strives not to have barriers that would stall all processes or threads for a particular operation to be completed. However, a barrier synchronization point is a requirement for the runtime component in Open MPI. We have developed an algorithm that implements barrier semantics by making effective use of HPX actions.
