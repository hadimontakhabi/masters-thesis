...
\iffalse
We have explained in precious sections that Open MPI has an abstraction layer for runtime environments. HPX-RTE provides an implementation of that abstraction layer using hpx. However, this abstraction layer is imperfect in practice. There is a lack of comprehensive documentation for it, and some of the interface independences were not implemented as they were designed.
...
\subsection{Features}
Database: local store, local or remote fetch
