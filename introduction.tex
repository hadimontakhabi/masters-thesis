...
MPI includes routines for blocking and non-blocking point-to-point communication, collective communication, and one-sided communication. It also provides support for generally defined datatypes (derived datatypes), process grouping (communicators), and parallel I/O~\cite{geist1996mpi,walker1996mpi}.
